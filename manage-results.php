...
<a href="manage-results.php?delete=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
