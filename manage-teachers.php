    <?php session_start();
        ...
        if (isset($_GET['TeachersId'])) {
            ...
            if (is_numeric($TeachersId)) {
                $sql = "DELETE FROM tblteachers WHERE TeachersId = :TeachersId";
                $query = $dbh->prepare($sql);
                $query->bindParam(':TeachersId', $TeachersId, PDO::PARAM_INT);
                $query->execute();
                                    ...
                                    <div class="row breadcrumb-div">
                                        <div class="col-md-6">
                                            <ul class="breadcrumb">
                                                ...
                                                <li> Teachers</li>
                                                <li class="active">ManageTeachers</li>
                                            </ul>
                                        </div>
