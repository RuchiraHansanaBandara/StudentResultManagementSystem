...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblteachers(TeacherName,TeacherID,TeacherEmail,Gender,ClassId,DOB,Status) VALUES(:teachername,:teacherid,:teacheremail,:gender,:classid,:dob,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':teachername',$teachername,PDO::PARAM_STR);
$query->bindParam(':teacherid',$teacherid,PDO::PARAM_STR);
$query->bindParam(':teachertemail',$teacheremail,PDO::PARAM_STR);
